  ...
  <html>
    ...
    <body>
      <div style="border:2px dotted; margin:0 0 5px 0; padding:.4rem;">
        ...
        <h1>Chicago Delight's</h1>
        <p style="text-align:center; margin-top:0; font-size:15px; padding:0 2px;">Opposite Swaraj Agency Kurukshetra,<br/>Road Pehowa(136-128),<br/>98966-42812 90340-62812</p>
        <hr />
